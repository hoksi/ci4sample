...
<p>
    `get()` 함수를 사용하면 SQL SELECT 문을 작성할 수 있습니다.</br>
...
<p>
    `getResult()` 함수는 $query 라는 변수에 할당되어 있으며 결과를 표시하는데 사용합니다.<br/>
    결과 생성에 대한 자세한 내용은 <a href="http://ci4doc.cikorea.net/database/results.html" target="_blank">결과(result)</a> 함수 페이지를 참조하십시오.
</p>
...
<p>
    다음 예에서 `limit()`을 지정하지 않아도 사용 가능한 이유는 $builder->get()을 사용하여 쿼리가 실행되지 않았기 때문입니다.<br/>
